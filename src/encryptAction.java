...
public class encryptAction implements ActionListener{
	...
	public encryptAction(JTextField inputPath, JTextField outputPath, JPasswordField passwordField, JFrame frame) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
		new encryptFile().encrypt(password, inputPath.getText().trim(), outputPath.getText().trim());
		JOptionPane.showMessageDialog(frame, "The File Encryption Was Successful!!!", "Success!!", JOptionPane.DEFAULT_OPTION);
		} catch (Exception e1) {
